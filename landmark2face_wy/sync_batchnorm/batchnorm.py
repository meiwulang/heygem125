...
# [Clang 14.0.6 ]
# Embedded file name: /code/landmark2face_wy/sync_batchnorm/batchnorm.py
# Compiled at: 2024-03-06 17:51:32
# Size of source mod 2**32: 16465 bytes
import collections, contextlib, torch
...
try:
    ...
    class _SynchronizedBatchNorm(_BatchNorm):
            ...
            def _data_parallel_master(self, intermediates):
                ...
                to_reduce = [j for i in to_reduce for j in iter(i)]
